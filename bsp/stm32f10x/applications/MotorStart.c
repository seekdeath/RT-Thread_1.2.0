...
{	
  ...
  Initial_Motor(4,M4DIV,73600);  	
	...
	TimerDly(500); 
	Start_Motor_S(1,M1_UNCLOCKWISE,200*70);  		 
	while(motor1.running==1);
	TimerDly(500); 
	
	Start_Motor_S(2,M2_CLOCKWISE,1600);  		 
	while(motor2.running==1);
	TimerDly(500); 
	Start_Motor_S(2,M2_UNCLOCKWISE,1600);  		 
	while(motor2.running==1);
	TimerDly(500); 
	...
	TimerDly(500);
#endif	
	Start_Motor_SPTA(4,M4_CLOCKWISE,200*1);  		 
	while(motor4.running==1);
	TimerDly(500); 
	Start_Motor_SPTA(4,M4_UNCLOCKWISE,200*1);  	 
	while(motor4.running==1); 
	TimerDly(500);
